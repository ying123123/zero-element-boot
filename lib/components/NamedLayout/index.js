...
const DefaultLayoutSet = require("../layout"); // change history
...
export default /*#__PURE__*/forwardRef(function NamedLayout({
  ...
  const Layout = LayoutSet[layoutName] || tips(layoutName); // just forward ref to the specified layout (e.g. Flexbox)
